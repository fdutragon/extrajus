...
5. Empregue linguagem solene, técnica e erudita, priorizando a mitigação de riscos e a máxima preservação dos direitos da parte representada.`
  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground overflow-hidden relative font-sans selection:bg-primary/30">
      ...
      <header className="fixed top-0 left-0 w-full h-12 sm:h-[clamp(2.5rem,4vh,3.25rem)] border-b border-border bg-background/60 backdrop-blur-2xl flex items-center justify-between px-3 z-[100] transition-all duration-500 hover:bg-background/80 group">
        ...
        <div className="flex-1 relative flex flex-col min-w-0 overflow-hidden">
          <main className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar bg-transparent max-sm:p-0 sm:p-[clamp(1rem,2vw,2rem)] pt-[4.5rem] max-sm:pt-0 sm:pt-[calc(clamp(2.5rem,4vh,3.25rem)+2rem)] relative z-10">
            ...
            <div className={cn(
              ...
              <div className="w-full h-full bg-card/90 dark:bg-card/75 backdrop-blur-xl sm:rounded-[30px] max-sm:rounded-none px-4 max-sm:px-0 py-8 max-sm:pt-20 max-sm:pb-24 sm:px-[clamp(2rem,4.5vw,4.5rem)] sm:py-[clamp(2.5rem,4.5vw,5.5rem)] relative min-h-[50rem] md:min-h-[74.25rem] editor-glow-content max-sm:bg-transparent max-sm:backdrop-blur-none max-sm:shadow-none">
