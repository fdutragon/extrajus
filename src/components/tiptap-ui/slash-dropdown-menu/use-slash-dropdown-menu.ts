    ...
    add_signature: {
      ...
      action: ({ editor }: { editor: Editor }) => {
        editor
          .chain()
          .focus()
          .insertContent('<p></p><p data-node-text-align="center">[Cidade] - [UF], [Dia] de [Mês] de [Ano].</p><p></p><p data-node-text-align="center" style="margin-top: 24px;">__________________________________________</p><p data-node-text-align="center"><strong>CONTRATANTE</strong></p><p></p><p data-node-text-align="center" style="margin-top: 24px;">__________________________________________</p><p data-node-text-align="center"><strong>CONTRATADO</strong></p>')
          .run()
      },
    },
    clausula: {
