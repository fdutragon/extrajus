...
import { BrainCircuit, Copy, CheckCircle2, Lock, Zap } from "lucide-react"
          ...
          <div className="md:col-span-6 flex flex-col justify-center border-b md:border-b-0 md:border-r border-border/60 pb-6 md:pb-0 md:pr-6 lg:pr-8 space-y-3">
            <div className="space-y-3">
              ...
              <p className="text-[15px] text-muted-foreground leading-relaxed font-medium">
                Adquira a cópia editável oficial (.docx) deste instrumento e ganhe <strong className="text-foreground font-bold">+3 contratos</strong> com auditoria de IA e assinatura digital ao desbloquear seu acesso.
              </p>
            </div>
                ...
                <div className="pt-2 space-y-2">
                  ...
                  {(process.env.NODE_ENV === "development" || email.toLowerCase().trim() === "felipedutra@outlook.com") && (
                    ...
                    >
                      ...
                      Criar Conta + Simular Pagamento (Dev)
                    </Button>
                  )}
                </div>
              </form>
            ...
            {step === "success" && (
              <div className="flex flex-col items-center justify-center space-y-4 py-8">
                ...
                <div className="space-y-1 text-center">
                  ...
                  <p className="text-xs text-muted-foreground font-medium">Iniciando download automático...</p>
                </div>
              </div>
            )}
          </div>
