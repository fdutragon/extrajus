            ...
            <table width="100%" max-width="600px" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; width: 100%; background-color: #0a0a0a; border: 1px solid #27272a; border-radius: 16px; padding: 25px 15px; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.8);">
              <tr>
                <td align="center" style="padding-bottom: 30px;">
                  <h2 style="color: #ffffff; font-weight: 900; letter-spacing: 0.15em; margin: 0; text-transform: uppercase; font-size: 24px;">SMARTDOC</h2>
              ...
              <tr>
                <td style="padding-bottom: 30px;">
                  ...
                  <p style="font-size: 15px; line-height: 1.6; color: #e4e4e7; margin: 0; padding-bottom: 15px;">
                    A minuta oficial de <strong>${title || 'Documento SmartDoc'}</strong> foi gerada e já está <strong style="color: #d4af37;">anexada a este e-mail no formato Word (.DOCX)</strong>.
                  </p>
                  <p style="font-size: 14px; line-height: 1.6; color: #71717a; margin: 0;">
                    Caso precise realizar alterações, fazer novas exportações ou baixar novamente, acesse a plataforma SmartDoc. O seu documento permanecerá salvo e 100% editável em nossa base.
                  </p>
                </td>
              </tr>
              <tr>
                <td align="center" style="border-top: 1px solid #27272a; padding-top: 25px;">
                  <p style="font-size: 11px; color: #52525b; margin: 0; line-height: 1.5;">
                    Este é um e-mail automático emitido pelos servidores da SmartDoc.<br>Por favor, não responda a esta mensagem.
                  </p>
                  <p style="font-size: 11px; color: #3f3f46; margin-top: 10px; margin-bottom: 0;">
                    © ${currentYear} SmartDoc. Todos os direitos reservados.
                  </p>
                </td>
              </tr>
            </table>
